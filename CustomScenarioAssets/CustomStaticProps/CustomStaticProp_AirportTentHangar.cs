...
{
    public CustomStaticProp_AirportTentHangar(string category, string id, string name, UnitSpawn.PlacementModes placementMode, bool alignToSurface) : base(category, id, name, placementMode, alignToSurface)
    {
